...
import type { SDesignResult, SteelGrade, LateralSupportType, DeflectionResult } from '../types/steel';
import { STEEL_PROPERTIES } from '../types/steel';
import { formatNumber, checkSSectionClass, calculateActualDeflection } from '../utils/steelDesign';

interface SDesignSummaryProps {
  result: SDesignResult;
...
export function SDesignSummary({ result, factoredMoment, factoredShear, steelGrade, lateralSupport, deflectionResult, span, udlSLS }: SDesignSummaryProps) {
    ...
    <div className="design-summary">
      ...
      <div className="print-container">
        <div className="print-header">
          <h1>S-Section Beam Design Calculation</h1>
        ...
        <div className="design-summary-print">
          ...
          <div className="print-footer">
            <span>DinoCalcs - S-Section Beam Design Tool</span>
