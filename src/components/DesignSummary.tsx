  ...
  return (
    <div className="design-summary">
      ...
      {lateralSupport === 'continuous' ? (
        <div className="summary-section">
          ...
          <div className="check-result pass">
            <MathJax inline>{`\\(M_f = ${formatNumber(factoredMoment)} \\text{ kN·m} \\leq M_r = ${formatNumber(Mr)} \\text{ kN·m}\\)`}</MathJax>
        ...
        <div className="summary-section">
          ...
          <div className="ltb-subsection">
            ...
            <div className="equation-block">
              ...
              <div className="parameter-values">
                <p>where:</p>
                <MathJax inline>{`\\(\\omega_2 = ${formatNumber(ltbResult.omega2, 2)}\\)`}</MathJax>,{' '}
                <MathJax inline>{`\\(L = ${formatNumber(ltbResult.unbracedLength, 0)} \\text{ mm}\\)`}</MathJax>,{' '}
                <MathJax inline>{`\\(E = 200{,}000 \\text{ MPa}\\)`}</MathJax>,{' '}
                <MathJax inline>{`\\(G = 77{,}000 \\text{ MPa}\\)`}</MathJax>
                <br />
                <MathJax inline>{`\\(I_y = ${Iy} \\times 10^6 \\text{ mm}^4\\)`}</MathJax>,{' '}
                <MathJax inline>{`\\(J = ${J} \\times 10^3 \\text{ mm}^4\\)`}</MathJax>,{' '}
                <MathJax inline>{`\\(C_w = ${Cw} \\times 10^9 \\text{ mm}^6\\)`}</MathJax>
              </div>
              <MathJax>
              ...
              {ltbResult.governingCase === 'elastic_ltb' ? (
                <>
                  <div className="case-indicator">
                    <MathJax inline>{`\\(M_u = ${formatNumber(ltbResult.Mu)} \\leq 0.67M_p = ${formatNumber(0.67 * ltbResult.Mp)}\\)`}</MathJax>
                ...
                <>
                  <div className="case-indicator">
                    <MathJax inline>{`\\(M_u = ${formatNumber(ltbResult.Mu)} > 0.67M_p = ${formatNumber(0.67 * ltbResult.Mp)}\\)`}</MathJax>
                ...
                <>
                  <div className="case-indicator">
                    <MathJax inline>{`\\(M_u = ${formatNumber(ltbResult.Mu)} > 0.67M_p\\)`}</MathJax>
          ...
          <div className={`check-result ${factoredMoment <= Mr ? 'pass' : 'fail'}`}>
            <MathJax inline>{`\\(M_f = ${formatNumber(factoredMoment)} \\text{ kN·m} ${factoredMoment <= Mr ? '\\leq' : '>'} M_r = ${formatNumber(Mr)} \\text{ kN·m}\\)`}</MathJax>
      ...
      <div className="summary-section">
        ...
        <div className="check-result pass">
          <MathJax inline>{`\\(V_f = ${formatNumber(factoredShear)} \\text{ kN} \\leq V_r = ${formatNumber(Vr)} \\text{ kN}\\)`}</MathJax>
          <span className="check-icon">✓</span>
        </div>
      </div>
      ...
      {deflectionResult && span && udlSLS && actualDeflection !== undefined && (
        <div className="summary-section">
          ...
          <div className="equation-block">
            ...
            <div className="parameter-values">
              <p>where:</p>
              <MathJax inline>{`\\(w_s = ${formatNumber(udlSLS, 2)} \\text{ kN/m}\\)`}</MathJax>,{' '}
              <MathJax inline>{`\\(L = ${formatNumber(span, 0)} \\text{ mm}\\)`}</MathJax>,{' '}
              <MathJax inline>{`\\(E = 200{,}000 \\text{ MPa}\\)`}</MathJax>,{' '}
              <MathJax inline>{`\\(I_x = ${section.Ix} \\times 10^6 \\text{ mm}^4\\)`}</MathJax>
            </div>
            <MathJax>
          ...
          <div className={`check-result ${actualDeflection <= deflectionResult.allowableDeflection ? 'pass' : 'fail'}`}>
            <MathJax inline>{`\\(\\delta_{actual} = ${formatNumber(actualDeflection, 2)} \\text{ mm} ${actualDeflection <= deflectionResult.allowableDeflection ? '\\leq' : '>'} \\delta_{allowable} = ${formatNumber(deflectionResult.allowableDeflection, 2)} \\text{ mm}\\)`}</MathJax>
      ...
      <div className="summary-section properties-table">
        ...
        <table>
          <tbody>
            ...
            <tr>
              <td><MathJax inline>{"\\(I_x\\)"}</MathJax></td>
              <td>{section.Ix} ×10⁶ mm⁴</td>
              <td><MathJax inline>{"\\(I_y\\)"}</MathJax></td>
              <td>{section.Iy} ×10⁶ mm⁴</td>
            </tr>
            <tr>
              <td><MathJax inline>{"\\(S_x\\)"}</MathJax></td>
              <td>{section.Sx} ×10³ mm³</td>
              <td><MathJax inline>{"\\(Z_x\\)"}</MathJax></td>
              <td>{section.Zx} ×10³ mm³</td>
            </tr>
            <tr>
              <td><MathJax inline>{"\\(J\\)"}</MathJax> (Torsional)</td>
              <td>{section.J} ×10³ mm⁴</td>
              <td><MathJax inline>{"\\(C_w\\)"}</MathJax> (Warping)</td>
