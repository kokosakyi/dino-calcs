...
import type { SDesignResult, SteelGrade } from '../types/steel';
import { STEEL_PROPERTIES } from '../types/steel';
import { formatNumber, utilizationPercent, checkSSectionClass } from '../utils/steelDesign';

interface SResultCardProps {
...
export function SResultCard({ result, rank, isSelected, onSelect, steelGrade, lateralSupport }: SResultCardProps) {
