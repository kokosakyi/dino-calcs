...
import { formatNumber, checkSSectionClass } from '../utils/steelDesign';
...
interface SCapacitySummaryProps {
  result: SCapacityResult;
  steelGrade: SteelGrade;
  lateralSupport: LateralSupportType;
}

export function SCapacitySummary({ result, steelGrade, lateralSupport }: SCapacitySummaryProps) {
    ...
    <div className="design-summary">
      ...
      <div className="print-container">
        <div className="print-header">
          <h1>S-Section Capacity Calculation</h1>
        ...
        <div className="design-summary-print">
          ...
          <div className="print-footer">
            <span>DinoCalcs - S-Section Capacity Calculator</span>
