  ...
  return (
    <div className="beam-design-page wood-design-page">
      <header className="page-header">
        <h1>Joist Design</h1>
        <p>Dimension lumber joists per CSA O86 (Table 6.3.1A, modification factors)</p>
      </header>
      ...
      <section className="input-panel">
        ...
        <div className="design-criteria full-width">
          ...
          <p className="criteria-note">Modification factors and φ per CSA O86 (sawn lumber)</p>
        </div>
      </section>

      <section className="calculations-panel">
        <ModulePrintSummary
          printTitle="Joist Design Calculation"
            ...
            <div className="inputs-grid print-two-col">
              <div className="input-group">
                ...
                <table className="inputs-table">
                  <tbody>
                    <tr>
                      <td>Factored loading (p<sub>f</sub>)</td>
                      <td>{factoredLoading} kPa</td>
                    </tr>
                    <tr>
                      <td>Service loading (p<sub>s</sub>)</td>
                      <td>{serviceLoading} kPa</td>
                    </tr>
                    <tr>
                      <td>Joist spacing (s)</td>
                      <td>{joistSpacing} mm</td>
                    </tr>
                    <tr>
                      <td>Joist span (L)</td>
                      <td>{joistSpan} mm</td>
                    ...
                    <tr>
                      <td>Bearing length (ℓ<sub>b</sub>)</td>
                      <td>{bearingLength} mm</td>
                    </tr>
                    <tr>
                      <td>Unsupported length (l<sub>u</sub>)</td>
