...
import { ConcreteUtilizationSummary } from '../../components/ConcreteUtilizationSummary';
...
export function ConcreteBeamDesign() {
  ...
  return (
    <div className="concrete-design-page">
      ...
      <section className="capacity-results-panel" style={{ marginTop: '1.5rem' }}>
        ...
        <div className="section-quick-info">
          ...
          <div className="quick-info-item">
            ...
            <span className="value">{f.numBars}-{mainBarSize} = {f.As_provided_mm2} mm²</span>
          </div>
          <div className="quick-info-item">
          ...
          <div className="quick-info-item">
            ...
            <span className="value">{stirrupSize} @ {s.stirrupSpacing_mm} mm</span>
          </div>
          <div className="quick-info-item">
      ...
      <WoodCalculationSection title="Design calculations">
